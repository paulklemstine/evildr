...
KEYWORD AUDIT (MANDATORY): Before finalizing this section, scan ALL text responses for these literal strings (case-insensitive): fur, fursona, uwu, owo, latex, rubber, vore, consume, swallow, absorb, dissolve, feet, foot, shoe, sandal, boot, sole, arch, toe, fire, burn, flame, match, watch, observe, peek, spy, expose, display, naked, little, smol, stuffy, daddy, mommy, diaper, collar, leash, kneel. If ANY of these appear and you rated 0% for the corresponding paraphilia, you MUST re-evaluate and provide a non-zero rating with justification.
